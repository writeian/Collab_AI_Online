...
(function() {
    ...
    async function handleNarrativeLibraryUpload(event) {
        ...
        try {
            const response = await fetch(`/api/library/upload?room_id=${roomId}`, {
                method: 'POST',
                headers: {
                    'X-CSRFToken': window.toolApi.getCsrfToken() || ''
                },
                body: formData
            });
    ...
    async function handleConfigSubmit(e) {
        ...
        try {
            const response = await window.toolApi.jsonFetch('/api/narrative/generate', {
                chat_id: chatId,
    ...
    async function generateFeedback() {
        ...
        try {
            ...
            const response = await window.toolApi.jsonFetch('/api/narrative/feedback', {
