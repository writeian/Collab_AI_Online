...
(function() {
    ...
    async function handleConfigSubmit(e) {
        ...
        try {
            const response = await (typeof jsonFetch === 'function' ? jsonFetch : fetch)('/api/quiz/generate', {
                method: 'POST',
                headers: {
    ...
    async function submitQuiz() {
        ...
        try {
            const response = await (typeof jsonFetch === 'function' ? jsonFetch : fetch)(`/api/quiz/${currentQuiz.id}/grade`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
